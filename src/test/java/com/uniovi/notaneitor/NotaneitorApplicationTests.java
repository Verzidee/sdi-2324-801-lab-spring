...
class NotaneitorApplicationTests {
    ...
    public void PR12() {
        ...
        List<WebElement> marksList = SeleniumUtils.waitLoadElementsBy(driver, "free", "//tbody/tr",
                PO_View.getTimeout());
        //Cambie aqui de 4 a 2 porque me inicia con paginacion de size 2
    ...
    public void PR13() {
        ...
        // Verificamos que estamos en la página correcta mediante un texto esperado
        String checkText = "Notas del usuario";
        List<WebElement> result = PO_View.checkElementBy(driver, "text", checkText);

        // Accedemos al detalle de una nota específica cambia aqui a NOTA A2 EN VEZ DE NOTA A4, porque me aparece en la ultima pestaña
        By enlace = By.xpath("//td[contains(text(), 'Nota A2')]/following-sibling::*[2]");
        driver.findElement(enlace).click();

        // Esperamos por la ventana de detalle de la nota
